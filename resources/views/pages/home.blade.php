        ...
        <div class="container">
            <div class="intro-content">
                ...
                <p class="scroll-reveal-right">
                    وقف المودة هو مؤسسة خيرية تأسست بهدف المساهمة في بناء مجتمع واعٍ ومتماسك، يقوم على القيم الإسلامية
                    الأصيلة والعمل الخيري المستدام.
                </p>
                <p class="scroll-reveal-left">
                    نسعى من خلال برامجنا المتنوعة إلى خدمة المجتمع في مجالات التعليم والثقافة والخدمات الاجتماعية، بما يحقق
                    التنمية المستدامة ويعود بالنفع على جميع أفراد المجتمع.
                </p>
            </div>
        </div>
    </section>
